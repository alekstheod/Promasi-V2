 ...
 *
 */
public class EmployeeHiredRequest extends Message {
     ...
     * @param dateTime
     */
    public EmployeeHiredRequest(MarketPlaceModel marketPlace, CompanyModel company, EmployeeModel employee, String dateTime) {
        _company = company;
