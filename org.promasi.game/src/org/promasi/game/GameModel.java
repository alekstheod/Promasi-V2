...
/**
 * @author m1cRo Represent the running game on the ProMaSi system. A GameModel
 * uses all the required components such as instance of
 * {@link MarketPlace}, {@link Company} a queue of {@link Project}s in order to
 * run the ProMaSi's game.
 */
public class GameModel extends Observer<IGameModelListener> {
    ...
    /**
     * Instance of {@link MarketPlace} needed in order to simulate the
     * marketplace.
     */
    protected MarketPlace _marketPlace;

    /**
     * Instance of {@link Company} needed in order to simulate the company in
     * ProMaSi sysstem.
     */
    protected Company _company;

    /**
     * A lock object needed in order to synchronize between the system's clock
     * and command threads.
     */
    private Lock _lockObject;

    /**
     * A queue of {@link Project} which will be executed by the company
     * {@link Company}.
     */
     ...
     * @param marketPlace instance of {@link MarketPlace} needed in order to
     * handle the employees.
     * @param company instance of {@link Company} needed in order to simulate
     * the company's work.
     * @param projects queue of {@link Project}s which will be executed by the
     * company.
    ...
    /**
     * Will return the current state of the object.
     *
     * @return instance of {@link GameModelMemento} - the current state of the
     * object.
     */
     ...
     *
     * @return {@link String} which represents the player's id. which is the
     * same with a company's owner id.
     */
